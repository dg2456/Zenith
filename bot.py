...
async def submit_application(user: discord.User, app_id: str):
    ...
    # Create embed for pending apps channel
    embed = discord.Embed(
    ...
    # Get guild and send to pending channel
